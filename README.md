...
| [`swatch`](stwatch) | A pipeline that types bacterial assemblies with [`mlst`](https://github.com/tseemann/mlst), flags novel/untyped and high-risk sequence types against a watch-list, and produces an interactive HTML report with plots alongside plain CSV/TSV tables. |
